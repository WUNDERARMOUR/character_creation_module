...
def attack(char_name: str, char_class: str) -> str:
    """The attack function shows us how different the damage
    is between the types the player has chosen.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """The defence function with the random module shows how much damage
       a hero can block depending on the class the player has chosen.
    """
    if char_class == 'warrior':
